...
export const catalogProducts: CatalogProduct[] = [
  ...
  {
    aliases: ['jumbo vaseline cheese'],
    categories: ['Vaseline'],
    collection: 'Vaseline Cheese',
    description: 'A viral cheese themed squishy filled with vaseline filling!',
    feel: 'Cloud Soft',
    id: 'jumbo-vaseline-cheese',
    imagePosition: [0, 0],
    name: 'Jumbo Vaseline Cheese',
    price: null,
    sku: 'SWS-VCZ-JUM',
    sortOrder: 150,
    status: 'published',
    subtitle: 'Jumbo Vaseline Cheese',
    tag: 'Jumbo',
  },
  {
    aliases: ['pineapple bun'],
    categories: ['Crunchy'],
    collection: 'Novelty',
    description: 'A crunchy bead and clay filled squishy- A definite must have!',
    feel: 'Crunchy',
    id: 'pineapple-bun',
    imagePosition: [0, 0],
    name: 'Crunchy Pineapple Bun',
    price: null,
    sku: 'SWS-PIN-BUN',
    sortOrder: 160,
    status: 'published',
    subtitle: 'Pineapple Bun',
    tag: 'Crunchy',
  },
  {
    aliases: ['crunchy caramel pudding'],
    categories: ['Crunchy'],
    collection: 'Novelty',
    description: 'A sensational bead and clay filled squishy!',
    feel: 'Crunchy',
    id: 'crunchy-caramel-pudding',
    imagePosition: [0, 0],
    name: 'Crunchy Caramel Pudding',
    price: null,
    sku: 'SWS-CCP-CLY',
    sortOrder: 170,
    status: 'published',
    subtitle: 'Crunchy Caramel Pudding',
    tag: 'Crunchy',
  },
  {
    aliases: ['color change lime', 'color change lime squishy'],
    categories: ['Crunchy'],
    collection: 'Crunchy',
    description: 'A lime-green crunchy squishy that shifts color as it warms in your hands.',
    feel: 'Crunchy',
    id: 'color-change-lime',
    imagePosition: [0, 0],
    name: 'Crunchy Color Change Lime',
    price: null,
    sku: 'SWS-CCL-LIM',
    sortOrder: 180,
    status: 'published',
